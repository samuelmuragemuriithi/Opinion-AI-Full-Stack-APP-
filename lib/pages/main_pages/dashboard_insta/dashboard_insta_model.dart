...
import 'dart:async';
import 'dashboard_insta_widget.dart' show DashboardInstaWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class DashboardInstaModel extends FlutterFlowModel<DashboardInstaWidget> {
  ...
  Completer<List<InstagramPostsRecord>>? firestoreRequestCompleter1;
  Completer<List<InstagramPostsRecord>>? firestoreRequestCompleter4;
  // State field(s) for TabBar widget.
  TabController? tabBarController2;
  int get tabBarCurrentIndex2 =>
      tabBarController2 != null ? tabBarController2!.index : 0;

  Completer<List<InstagramPostsRecord>>? firestoreRequestCompleter3;
  Completer<List<InstagramPostsRecord>>? firestoreRequestCompleter2;
