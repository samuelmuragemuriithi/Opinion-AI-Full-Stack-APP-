                                ...
                                if (responsiveVisibility(
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'MAIN_MESSAGES_chevron_left_rounded_ICN_O');
                                        context.safePop();
                                      },
                                    ),
                                  ),
                                      ...
                                      child: SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FutureBuilder<
                                                List<CommentTestRecord>>(
                                              future:
                                                  queryCommentTestRecordOnce(),
                                              builder: (context, snapshot) {
                                                ...
                                                List<CommentTestRecord>
                                                    listMessagesCommentTestRecordList =
                                                    snapshot.data!;
                                                return Column(
                                                  mainAxisSize:
                                                      MainAxisSize.max,
                                                  children: List.generate(
                                                      listMessagesCommentTestRecordList
                                                          .length,
                                                      (listMessagesIndex) {
                                                    final listMessagesCommentTestRecord =
                                                        listMessagesCommentTestRecordList[
                                                            listMessagesIndex];
                                                    return InkWell(
                                                      splashColor:
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'MAIN_MESSAGES_Container_3yu4rnva_ON_TAP');
                                                              ...
                                                              child: Padding(
                                                                padding: MediaQuery
                                                                    .viewInsetsOf(
                                                                        context),
                                                                child:
                                                                    UserDetailsMainWidget(
                                                                  username:
                                                                      listMessagesCommentTestRecord
                                                                          .email,
                                                                  text:
                                                                      listMessagesCommentTestRecord
                                                                          .test,
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'MAIN_MESSAGES_PAGE_Row_3gauvrp5_ON_TAP');
                                                                        ...
                                                                        context
                                                                          ...
                                                                          queryParameters:
                                                                            ...
                                                                            'username':
                                                                                serializeParam(
                                                                              listMessagesCommentTestRecord.email,
                                                                              ParamType.String,
                                                                            ),
                                                                            'text':
                                                                                serializeParam(
                                                                              listMessagesCommentTestRecord.test,
                                                                              ParamType.String,
                                                                            ),
                                                                          }.withoutNulls,
                                                                        );
