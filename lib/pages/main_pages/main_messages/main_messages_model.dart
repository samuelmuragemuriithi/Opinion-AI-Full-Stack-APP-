...
class MainMessagesModel extends FlutterFlowModel<MainMessagesWidget> {
  ...
  List<CommentsTypeStruct> listA = [];
  void addToListA(CommentsTypeStruct item) => listA.add(item);
  void removeFromListA(CommentsTypeStruct item) => listA.remove(item);
  void removeAtIndexFromListA(int index) => listA.removeAt(index);
  void insertAtIndexInListA(int index, CommentsTypeStruct item) =>
      listA.insert(index, item);
  void updateListAAtIndex(int index, Function(CommentsTypeStruct) updateFn) =>
