                      ...
                      child: Stack(
                        ...
                        children: [
                          Align(
                            ...
                            child: Image.network(
                              'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxpZ3xlbnwwfHx8fDE3MTI5NTQ3NDJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                              width: double.infinity,
                              height: 240.0,
                              fit: BoxFit.cover,
                            ).animateOnPageLoad(
                                ...
                                Row(
                                  ...
                                  children: [
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'USER_DETAILS_MAIN_cancel_outlined_ICN_ON');
              ...
              children: [
                Expanded(
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('USER_DETAILS_MAIN_RESPOND_BTN_ON_TAP');
                ...
                Expanded(
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'USER_DETAILS_MAIN_AUTOGENERATE_ANSWER_BT');
