        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'homePagePhone',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'homePagePhone')
                  : HomePagePhoneWidget(),
            ),
            FFRoute(
              name: 'jlj',
              path: 'jlj',
              builder: (context, params) => JljWidget(),
            ),
            FFRoute(
              name: 'dashboardInsta',
              path: 'dashboardInsta',
              builder: (context, params) => DashboardInstaWidget(),
            )
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Image.asset(
                        'assets/images/Orange_Beige_Retro_Sale_Fashion_Animated_Instagram_Post_(3).png',
                        fit: BoxFit.cover,
                      ),
                    )
              : page;
