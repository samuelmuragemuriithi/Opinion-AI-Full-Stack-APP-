...
import 'schema/comment_test_record.dart';
...
export 'schema/comment_test_record.dart';
...
/// Functions to query CommentTestRecords (as a Stream and as a Future).
Future<int> queryCommentTestRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CommentTestRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CommentTestRecord>> queryCommentTestRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CommentTestRecord.collection,
      CommentTestRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CommentTestRecord>> queryCommentTestRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
